...
# dependency jars to read data from kafka
REQUIRED_JARS = [
...
class StreamJobConfig:
    ...
    jars: List[str] = field(default_factory=lambda: REQUIRED_JARS) # field to make a seperate copy of required jars
...
def get_sql_query(entity: str, type: str = 'source', template_env: Environment = Environment(loader=FileSystemLoader("code/")),) -> str:
    config_map = {
...
def run_checkout_attribution_job(t_env: StreamTableEnvironment, get_sql_query=get_sql_query,) -> None:
    # Create Source DDLs
